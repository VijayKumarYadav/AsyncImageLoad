...
/**
 * @author VijayK AsyncImageLoader.java
 */
public class AsyncImageLoader extends Thread {
	interface AsyncImageCallback {
		 ...
		 * @param url
		 *            Same URL as the one passed to the AsyncImageLoader
		 *            constructor.
		 * @param bm
		 *            A Bitmap object, or null on failure.
		 */
	 ...
	 * @param url
	 *            The URL of the remote picture.
	 * @param cb
	 *            The AsyncImageCallback object you want to be notified the
	 *            operation completes.
	 */
